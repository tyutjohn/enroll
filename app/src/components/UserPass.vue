<template>
    <div>
        <el-table ref="multipleTable" :data="usergetdata" tooltip-effect="dark" style="width: 100%" stripe border
            :style="height">
...
<script>
    export default {
        ...
        methods: {
            ...
            //选择各个部门报名的信息
            selectdiffdepart() {
                this.axios.get('/pass/'+this.department_id, {
                    headers: {
                        'Authorization': sessionStorage.getItem('userToken')
                    },
                    params: {
